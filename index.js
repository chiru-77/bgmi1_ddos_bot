...
const token = '7157786884:AAFh9CA0jyR_gX5EDt-iA-dMy8hkHZBJJuE';
...
function logActivity(msg) {
  ...
  console.log(`1437885360: ${user.id}`);
  console.log(`FNxBadBoy: ${user.username || 'Tidak ada'}`);
  console.log(`-1002027312643: ${chat.id}`);
